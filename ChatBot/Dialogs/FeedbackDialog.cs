...
namespace ChatBot.Dialogs
{
    ...
    /// </summary>
    public abstract class FeedbackDialog : LuisDialog<object>
    {
        private readonly LuisResult originalLuisResult;
        private readonly IChatBotDialogFactory dialogFactory;

        protected FeedbackDialog(ILuisService service, IChatBotDialogFactory dialogFactory, LuisResult result) : base(service)
        {
